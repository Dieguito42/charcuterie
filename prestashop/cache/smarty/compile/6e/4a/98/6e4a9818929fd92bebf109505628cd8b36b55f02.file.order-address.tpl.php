<?php /* Smarty version Smarty-3.1.14, created on 2013-10-18 16:25:53
         compiled from "/Applications/MAMP/htdocs/charcuterie/prestashop/themes/default/order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:884619910526144f1b0cc66-88844736%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6e4a9818929fd92bebf109505628cd8b36b55f02' => 
    array (
      0 => '/Applications/MAMP/htdocs/charcuterie/prestashop/themes/default/order-address.tpl',
      1 => 1381141710,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '884619910526144f1b0cc66-88844736',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_526144f2cc1850_94016672',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526144f2cc1850_94016672')) {function content_526144f2cc1850_94016672($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/Applications/MAMP/htdocs/charcuterie/prestashop/tools/smarty/plugins/function.counter.php';
if (!is_callable('smarty_modifier_escape')) include '/Applications/MAMP/htdocs/charcuterie/prestashop/tools/smarty/plugins/modifier.escape.php';
?>
...
?>
					<?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['inv_loop']['first']){?>,<?php }?><?php echo json_encode($_smarty_tpl->tpl_vars['field_name']->value);?>
...
$_smarty_tpl->tpl_vars['field_name']->_loop = true;
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['inv_loop']['first'] = $_smarty_tpl->tpl_vars['field_name']->first;
?>
						<?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['inv_loop']['first']){?>,<?php }?><?php echo json_encode($_smarty_tpl->tpl_vars['pattern_name']->value);?>
:<?php echo json_encode($_smarty_tpl->tpl_vars['field_name']->value);?>
